...
void ImuProcess::IMU_init(const MeasureGroup &meas, StatesGroup &state_inout,
  ...
  RCLCPP_INFO(rclcpp::get_logger(""), "IMU Initializing: %.1f %%",
...
void ImuProcess::UndistortPcl(LidarMeasureGroup &lidar_meas,
  ...
  // {
  //   pcl_wait_proc.emplace_back(*pcl_it);
  //   pcl_it++;
  //   lidar_meas.lidar_scan_index_now++;
  // }
  ...
  if (lidar_meas.lio_vio_flg == LIO) {
    ...
    IMUpose.emplace_back(set_pose6d(0.0, acc_s_last, angvel_last,
  ...
  state_inout.ang_vel_end = angvel_avr;
  ...
  if (imu_need_init) {
    ...
    if (init_iter_num > MAX_INI_COUNT) {
      ...
      RCLCPP_INFO(rclcpp::get_logger(""),
                  ...
                  mean_acc.norm(), cov_acc[0], cov_acc[1], cov_acc[2],
